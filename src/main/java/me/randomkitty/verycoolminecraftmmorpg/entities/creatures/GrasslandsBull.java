...
public class GrasslandsBull extends CustomCow {

    private static final List<DefaultLootDrop> defaultDrops = new ArrayList<>();

    private static final DefaultLootDrop bullHideDrop = new DefaultLootDrop(0, 1, CustomItems.COW_HIDE);

    static {
        defaultDrops.add(bullHideDrop);
    }

    private StayCloseToOrginGoal stayCloseToOrginGoal;

    public GrasslandsBull(World world) {
        super(world);
    ...
    public String getBaseName() {
        return ChatColor.DARK_GREEN + "Grasslands Bull";
    }
}
